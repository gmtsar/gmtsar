...
#
  ...
  gmt psconvert -Tf -P -A -Z corr.ps
...
#
  ...
  gmt psconvert -Tf -P -A -Z phase.ps
...
#  phasefilt -imag imagfilt.grd -real realfilt.grd -amp1 amp1.grd -amp2 amp2.grd -psize 16 
  phasefilt -imag imagfilt.grd -real realfilt.grd -amp1 amp1.grd -amp2 amp2.grd -alpha -1 -psize 32
