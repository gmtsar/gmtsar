...
if (-e xphase_mask.grd) then
  ...
  gmt grdimage xphase_mask.grd -JX8i -Cxphase.cpt -X.2i -Y.5i -Q -P -K > xphase_mask.ps
  ...
  gmt grdimage yphase_mask.grd -JX8i -Cyphase.cpt -X.2i -Y.5i -Q -P -K > yphase_mask.ps
