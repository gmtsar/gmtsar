# Perf snapshot — full, 2026-06-14T00-22-55Z
...
| ✓ CSK_SLC_Italy | 791s | 658s | +133s | 1.20× | 6/0 |
...
| CSK_SLC_Italy | **657s** | 401s | 74s | 30s | 35s | 40s | 27s |
...
|-------|------:|--------------:|-------|
| dem2topo_ra | 28647s | 77.8% | gmt-wrapper |
| pre_proc | 3083s | 8.4% | C bin |
| merge_unwrap_geocode_tops | 2167s | 5.9% | ? |
| geocode | 1020s | 2.8% | gmt-subprocess |
| intf | 765s | 2.1% | C bin |
| resamp_py | 672s | 1.8% | Numba py |
| xcorr_py | 365s | 1.0% | scipy.fft py |
...
_Snapshot generated: 2026-06-14T00-22-55Z_  
_Source: sweep.log_  
