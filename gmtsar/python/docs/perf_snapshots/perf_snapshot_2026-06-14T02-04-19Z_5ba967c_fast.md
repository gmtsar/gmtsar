# Perf snapshot — fast, 2026-06-14T02-04-19Z
...
|------|----:|---:|--:|--------:|:------|
| ✓ RS2_SLC_Hawaii | 182s | 88s | +94s | 2.07× | 6/0 |
...
| RS2_SLC_Hawaii | **87s** | 32s | 4s | 23s | 14s | 4s | 1s |

## Table 3 — Aggregate cost by stage (across 20 profiled cases)

| Stage | Total | % of pipeline | Class |
|-------|------:|--------------:|-------|
| dem2topo_ra | 28630s | 77.9% | gmt-wrapper |
| pre_proc | 3053s | 8.3% | C bin |
| merge_unwrap_geocode_tops | 2169s | 5.9% | ? |
| geocode | 999s | 2.7% | gmt-subprocess |
| intf | 748s | 2.0% | C bin |
...
_Snapshot generated: 2026-06-14T02-04-19Z_  
_Source: sweep.log_  
