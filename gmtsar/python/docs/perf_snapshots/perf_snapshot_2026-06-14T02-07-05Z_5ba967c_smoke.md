# Perf snapshot — smoke, 2026-06-14T02-07-05Z

**Commit:** `5ba967c` (dirty)  
...
| ✓ ALOS_haiti | 1713s | 1539s | +174s | 1.11× | 7/0 |
| ✓ ERS_Hector_EQ | 1212s | 1103s | +109s | 1.10× | 6/0 |
| ✓ S1A_SLC_TOPS_COVE | 5497s | 5096s | +401s | 1.08× | 10/0 |
| ✓ S1A_SLC_TOPS_LA | 6677s | 6200s | +477s | 1.08× | 10/0 |
| ✓ S1A_SLC_TOPS_Greece | 3000s | 2869s | +131s | 1.05× | 10/0 |
...
| CSK_RAW_Hawaii | **599s** | 72s | 83s | 50s | 22s | 35s | 14s |
| ALOS_SLC_L1.1 | **293s** | 104s | 28s | 17s | 50s | 15s | 20s |
| NISAR_Ethiopia | **283s** | 24s | 5s | 35s | 46s | 5s | - |
| RS2_SLC_Hawaii | **94s** | 33s | 4s | 25s | 15s | 5s | 1s |

## Table 3 — Aggregate cost by stage (across 20 profiled cases)

| Stage | Total | % of pipeline | Class |
|-------|------:|--------------:|-------|
| dem2topo_ra | 28631s | 77.9% | gmt-wrapper |
| pre_proc | 3054s | 8.3% | C bin |
| merge_unwrap_geocode_tops | 2169s | 5.9% | ? |
| geocode | 1000s | 2.7% | gmt-subprocess |
| intf | 749s | 2.0% | C bin |
| resamp_py | 677s | 1.8% | Numba py |
| xcorr_py | 388s | 1.1% | scipy.fft py |
...
_Snapshot generated: 2026-06-14T02-07-05Z_  
_Source: sweep.log_  
