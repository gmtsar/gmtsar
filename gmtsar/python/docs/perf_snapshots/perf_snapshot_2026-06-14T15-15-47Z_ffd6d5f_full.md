# Perf snapshot — full, 2026-06-14T15-15-47Z

**Commit:** `ffd6d5f` (dirty)  
...
| ✗ S1_Ridgecrest_EQ | 9181s | 8197s | +984s | 1.12× | 15/1 |
...
| S1_Ridgecrest_EQ | **4048s** | 3814s | - | - | - | 75s | 599s |
...
|-------|------:|--------------:|-------|
| dem2topo_ra | 31846s | 79.3% | gmt-wrapper |
| pre_proc | 3076s | 7.7% | C bin |
| merge_unwrap_geocode_tops | 2188s | 5.5% | ? |
...
### S1_Ridgecrest_EQ — score 15/1, py=8197s
...
_Snapshot generated: 2026-06-14T15-15-47Z_  
_Source: sweep.log_  
