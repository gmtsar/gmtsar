# Perf snapshot — fast, 2026-07-13T06-24-11Z
...
**Sweep wall:** 0h 15m (941s)  

**Coverage:** 20 cases with scorecards. **18 pass / 2 fail**.
...
## Table 3 — Aggregate cost by stage (across 19 profiled cases)

| Stage | Total | % of pipeline | Class |
|-------|------:|--------------:|-------|
| dem2topo_ra | 24635s | 76.2% | gmt-wrapper |
| pre_proc | 2453s | 7.6% | C bin |
| merge_unwrap_geocode_tops | 1745s | 5.4% | ? |
| geocode | 1060s | 3.3% | gmt-subprocess |
| snaphu | 688s | 2.1% | C bin |
| resamp_py | 678s | 2.1% | Numba py |
| intf | 670s | 2.1% | C bin |
| xcorr_py | 389s | 1.2% | scipy.fft py |
...
_Snapshot generated: 2026-07-13T06-24-11Z_  
_Source: sweep.log_  
