...
int64_t lsqlin_sov_ts(int64_t, int64_t, float *, float *, int64_t *, double *, double *, double *, double *, double *, double *,
...
int connect_(int64_t *, int64_t *, double *, int64_t *, int64_t *, int64_t, int64_t, int64_t, int64_t);
