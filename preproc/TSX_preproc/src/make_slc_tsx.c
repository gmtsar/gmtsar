...
int main(int argc, char **argv){
    ...
    if ((INPUT_SLC = fopen(argv[2], "rb")) == NULL) die ("Couldn't open data file: \n",argv[2]);
...
int pop_prm(struct PRM *prm,tree *xml_tree,char *file_name){
    ...
    prm->SC_identity = 7; /* (1)-ERS1 (2)-ERS2 (3)-Radarsat (4)-Envisat (5)-ALOS (6)-  (7)-TSX (8)-CSK (9)-RS2 (10) Sentinel-1a*/
